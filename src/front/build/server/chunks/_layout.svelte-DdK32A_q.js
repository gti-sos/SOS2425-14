...
function Navbar($$payload, $$props) {
  push();
  $$payload.out += `<header id="navbar"><h1>SOS2425-14</h1> <nav><ul><li><a href="/">Home</a></li> <li class="dropdown"><a id="samples-link" style="cursor: pointer;">APIs<span class="dropdown-arrow"></span></a> <ul class="dropdown-content"><li><a href="/api/v1/education-data">Education</a></li> <li><a href="/api/v1/employment-data">Employment</a></li> <li><a href="/api/v1/cybercrime-data">Crime</a></li></ul></li> <li><a href="/about">About</a></li></ul></nav> <i class="fas fa-bars" id="menu-icon-open"></i></header>`;
  pop();
}
...
function _layout($$payload, $$props) {
  ...
  $$payload.out += `<!----> `;
  GitHub($$payload);
  $$payload.out += `<!----> <div class="wrapper"><div class="container"><!---->`;
...
//# sourceMappingURL=_layout.svelte-DdK32A_q.js.map
