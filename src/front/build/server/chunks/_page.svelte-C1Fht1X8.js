...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<div class="wrapper"><div class="container"><h2 style="text-align: center;">Integraciones <br><i>Francisco Javier</i></h2> <hr style="width: 100%; animation: loadHrGraph 1s; transition: all 0.3s ease;"> <div><div class="article" style="margin-top: 0;"><h3 style="font-size: 1.5em; text-transform: none;">Distribución del Uso del Suelo en Cádiz</h3> <p>Este gráfico representa cómo se reparte la superficie de la provincia de Cádiz entre
					...
					predomina en el territorio durante el año seleccionado.</p> <a style="color: #fff;"${attr("href", API_G15)} target="_blank"><i>G15 - ocupied-grand-stats</i></a> <figure class="chartjs-figure svelte-47s6as">`;
  {
    $$payload.out += "<!--[-->";
    $$payload.out += `<p style="color: #fff; text-align: center; font-weight: bold;">Cargando datos...</p>`;
  }
  $$payload.out += `<!--]--> <canvas id="15Chart"></canvas></figure></div> <div class="article" style="margin-top: 1em;"><h3 style="font-size: 1.5em; text-transform: none;">Accidentes con Animales por Grupo (2023)</h3> <p>Este gráfico muestra cuántos accidentes de tráfico con animales estuvieron relacionados
  ...
  $$payload.out += `<!--]--> <canvas id="20Chart"></canvas></figure></div> <div class="article" style="margin-top: 0;"><h3 style="font-size: 1.5em; text-transform: none;">Distribución del Consumo Energético por Fuente</h3> <p>Este gráfico radar muestra cómo se reparte el consumo energético entre electricidad, gas y
					otras fuentes en Andalucía durante el año 2021. Esta visualización permite comparar
					fácilmente las prioridades energéticas regionales y su evolución temporal.</p> <a style="color: #fff;"${attr("href", API_G12)} target="_blank"><i>G12 - annual-consumptions</i></a> <figure class="chartjs-figure svelte-47s6as">`;
  {
    $$payload.out += "<!--[-->";
    $$payload.out += `<p style="color: #fff; text-align: center; font-weight: bold;">Cargando datos...</p>`;
  }
  $$payload.out += `<!--]--> <canvas id="12Chart"></canvas></figure></div> <div class="article" style="margin-top: 0;"><h3 style="font-size: 1.5em; text-transform: none;">Superficie Actual de los Parques Nacionales</h3> <p>Este gráfico muestra la superficie actual en hectáreas de los distintos parques nacionales
  ...
  $$payload.out += `<!--]--> <canvas id="13Chart"></canvas></figure></div> <div class="article" style="margin-top: 2em;"><h3>Comparativa Climática de Varias Ciudades</h3> <p>Este gráfico de burbujas permite comparar en tiempo real la temperatura, humedad y
					...
					Permite visualizar cómo varía la temperatura a lo largo de la jornada.</p> <a style="color: #fff;" href="https://www.aemet.es/es/eltiempo/prediccion/municipios/sevilla-id41091" target="_blank"><i>AEMET - Predicción Sevilla</i></a> <figure class="chartjs-figure svelte-47s6as"><p id="mensaje" style="color: #fff; text-align: center; font-weight: bold;"></p> <canvas id="aemetChart"></canvas></figure></div></div></div></div>`;
  pop();
}

export { _page as default };
//# sourceMappingURL=_page.svelte-C1Fht1X8.js.map
